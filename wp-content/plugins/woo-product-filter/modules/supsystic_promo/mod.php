<?php
class supsystic_promoWpf extends moduleWpf {
	private $_mainLink = '';
	...
	public function checkAdminPromoNotices() {
		...
		if($startUsage) {	// Already saved
			...
			$rateMsg .= '<p><a href="https://wordpress.org/support/view/plugin-reviews/popup-by-supsystic?rate=5#postform" target="_blank" class="button button-primary" data-statistic-code="done">'. __('Ok, you deserve it', WPF_LANG_CODE). '</a>
