...
$attrDisplay = array(0 => __('Select...', WPF_LANG_CODE));
						...
						<div class="wpfCopyTextCodeSelectionShell col-lg-8 col-md-9">
							<div class="row">
								...
								<div class="col-md-4 wpfShortcodeAdm">
									...
									<i class="fa fa-question supsystic-tooltip" style="margin-left: 12px;" title="<?php echo esc_html(__('Table PHP code: lets display the table through themes/plugins files (for example in the site footer). You can use shortcode in this way. ', WPF_LANG_CODE))?>"></i>
								</div>
                                <?php $id = isset($this->filter['id']) ? $this->filter['id'] : ''; ?>
                                <?php if($id) {?>
								<div class="col-md-4 wpfCopyTextCodeShowBlock wpfShortcode shortcode" style="">
									<?php
										echo htmlWpf::text('shortcode', array(
